...
// 5.Create dataframe from DB using jdbc.
    ...
    println("Create dataframe using case class from file Reflection")
...
//So it's basically a choice between tuples and collections. 
 ...
 //https://spark.apache.org/docs/2.3.0/api/sql/
    ...
    val casttostring=dfcsv.withColumn("Stringage",$"_c3".cast("String"))
    ...
    sqlc.sql("""select trimupper(custprofession) as custprofupper 
